        ...
        <div className="grid grid-cols-2 gap-8">
          {developers.map((developer) => (
            <div key={developer.name} className="flex flex-col items-center">
              ...
              <h5 className="text-lg font-semibold mt-4 text-black">{developer.name}</h5>
              ...
              <div>
                ...
                {/*<!-- LinkedIn -->*/}
                <a href="#!" class="px-2">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-6 w-6 text-primary dark:text-primary-400" >
