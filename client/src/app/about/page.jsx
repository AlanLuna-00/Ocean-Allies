        ...
        <div className="grid grid-cols-4 gap-8  rounded-lg bg-gray-100 p-6 bg-opacity-60 shadow-xl">
          {developers.map((developer) => (
            <div className="container">
              ...
              >
                <div className="relative w-[100%] sm:w-[80%] md:w-[60%] lg:w-[40%] xl:w-[30%] mx-auto h-auto rounded-t-2xl overflow-hidden">
                  <Image
                    src={developer.image}
                    alt={developer.name}
                    width={300}
                ...
                <div className="bg-neutral-100 shadow-xl relative w-[100%] sm:w-[80%] md:w-[60%] lg:w-[40%] xl:w-[30%] pb-2 rounded-b-2xl">
                  <h5 className="text-xl sm:text-2xl font-semibold mt-4 text-gray text-center">
                    {developer.name}
                  </h5>
